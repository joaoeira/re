...
import { toScanDecksErrorMessage, type DeckEntry } from "../workspace/index.js";
...
export const prepareCard = Effect.fn("Study.prepareCard")(function* (input: CreateCardInput) {
...
export const createCard = Effect.fn("Study.createCard")(function* (input: CreateCardInput) {

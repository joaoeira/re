...
The entry point exports ESM JavaScript and TypeScript declarations. Its asynchronous and fallible
APIs use Effect.
...
multiple cards sharing one content block. The module also exports card-type contracts and

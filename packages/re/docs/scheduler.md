...
FSRS scheduling for re items, independent of workspace storage. This module takes card
...
creates the installable package archive and `bun run check:packages` verifies isolated scheduler

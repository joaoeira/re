...
There is one published package, version, and changelog. The desktop and Overlay apps are private packages; release preparation preserves their frozen library dependencies and their own versions.
